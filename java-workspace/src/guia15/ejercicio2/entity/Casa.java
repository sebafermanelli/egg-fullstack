...
public class Casa {
    ...
    public Casa(int id, String calle, int numero, String codigo_postal, String ciudad, String pais, Date fecha_desde, Date fecha_hasta, int tiempo_minimo, int tiempo_maximo, double precio_habitacion, String tipo_vivienda) {
        this.id = id;
        this.calle = calle;
        this.numero = numero;
