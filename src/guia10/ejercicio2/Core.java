...
import guia10.ejercicio2.services.MascotaService;
...
public class Core {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.print("Ingrese el nombre de una mascota a buscar: ");
        String nombre = scanner.nextLine();
        System.out.println(MascotaService.obtenerMascotaNombre(nombre));
    }
}
